...
config("closed") = 0
config("isdebug") = 0
config("base_url") = "http://www.ithinkido.cn/"
config("index_page") = "index.htm"
config("contact_email") = "wyrover@gmail.com"

config("sitetitle") = "Rover的Blog"
config("site_name") = "IthinkIdo"
config("site_description") = "IthinkIdo"
...
config("attachment_img_dir") = "blog"
...
config("upload_file_ext") = "rar|zip|gif|jpg|png|torrent"
