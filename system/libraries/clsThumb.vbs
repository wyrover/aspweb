Class Thumb
	...
	Function CreateThumbs(FileName, ThumbFileName)
		...
		strSql = "Select ThumbComponent,RateTF,ThumbWidth,ThumbHeight,ThumbRate From KS_Thumb"
	...
	Function CreateThumb(FileName, Width, Height, Rate, ThumbFileName)
		...
		strSql = "Select ThumbComponent From KS_Thumb"
		...
		Select Case CInt(RsSetting("ThumbComponent"))
			...
			Case 4
				If Not KSCMS.IsObjInstalled("CreatePreviewImage.cGvbox") Then       
					Exit Function
				End If
